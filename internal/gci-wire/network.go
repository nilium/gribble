// The following source code is copyright (c) 2015-2019 GitLab B.V.
// It is licensed under an MIT license, available in the LICENSE file accompanying this source code.
...
func (j *JobResponse) RepoCleanURL() string {
	return cleanURL(j.GitInfo.RepoURL)
}
